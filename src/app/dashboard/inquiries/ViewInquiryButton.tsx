            ...
            <DialogContent className="sm:max-w-[625px]">
                ...
                <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="col-span-3 font-medium">{format(new Date(inquiry.created_at), 'PPP p')}</div>
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                     ...
                     <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="col-span-3 font-medium">{inquiry.email}</div>
                    </div>
                     <div className="grid grid-cols-4 items-center gap-4">
                        <Label className="text-right text-muted-foreground">Mobile</Label>
                        <div className="col-span-3 font-medium">{inquiry.mobile || 'N/A'}</div>
                    </div>
                     <div className="grid grid-cols-4 items-center gap-4">
