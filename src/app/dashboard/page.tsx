    ...
    <div className="flex flex-col gap-4">
       ...
       <Card className="border-0 shadow-none rounded-none">
        <CardHeader className="px-4 sm:px-6">
          <CardTitle className="text-sm font-semibold">My Inquiries</CardTitle>
        </CardHeader>
                 ...
                 <Table className="text-xs">
                    <TableHeader>
                        <TableRow className="bg-muted/50 hover:bg-muted/50 h-8">
                            ...
                            <TableHead className="h-8 py-0 px-4 sm:px-6">Mobile</TableHead>
                    ...
                    {inquiries.map((inquiry) => {
                        ...
                        <TableCell className="py-0 px-4 sm:px-6">{inquiry.mobile || 'N/A'}</TableCell>
                        <TableCell className="py-0 px-4 sm:px-6 capitalize">
