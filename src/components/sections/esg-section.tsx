...
const sectionText = {
  ...
  hi: {
    heading: "ईएसजी और स्थिरता",
    subheading: "एक बेहतर भविष्य का निर्माण, एक साथ।",
    empowering: {
      title: "स्थानीय उद्यमियों को सशक्त बनाना",
      description: "जमीनी स्तर पर नवाचार और स्थानीय अर्थव्यवस्थाओं को बढ़ावा देने के लिए उपकरण और परामर्श प्रदान करना।"
    },
    carbon: {
      title: "कार्बन न्यूट्रल",
      description: "हमारे संचालन 100% कार्बन न्यूट्रल हैं, जो एक हरित ग्रह में निवेश कर रहे हैं।"
    },
    literacy: {
      title: "डिजिटल साक्षरता",
      description: "मुफ्त कार्यशालाओं और शैक्षिक कार्यक्रमों के साथ डिजिटल अंतर को पाटना।"
    }
  }
};
