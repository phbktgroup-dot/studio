...
const content = {
  ...
  hi: {
    heading: 'अपना भविष्य यहाँ खोजें',
    subheading:
      'हम इनोवेटर्स, विचारकों और बिल्डरों की एक टीम हैं जो बदलाव लाने के लिए समर्पित हैं। आपके अद्वितीय कौशल हमें आगे बढ़ने में मदद कर सकते हैं। हमसे जुड़ें।',
    cta: 'खुलीตำแหน่งें देखें',
    pillars: [
      {
        icon: Lightbulb,
        title: 'उद्देश्य के साथ नवाचार करें',
        description:
