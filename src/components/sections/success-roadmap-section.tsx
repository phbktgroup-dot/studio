...
const text = {
  ...
  hi: {
    ...
    h2: "आपकी सफलता के हर कदम पर हम आपके साथ हैं।",
    milestones: [
      { title: "विचार और पंजीकरण", icon: MilestoneIcon, description: "एक मजबूत नींव बनाने के लिए अपनी अवधारणा को मजबूत करें और सभी कानूनी पंजीकरण को संभालें।" },
      { title: "सत्यापन और रणनीति", icon: ClipboardCheck, description: "कोड की एक भी पंक्ति लिखने से पहले उत्पाद-बाजार फिट सुनिश्चित करने के लिए बाजार अनुसंधान, उपयोगकर्ता साक्षात्कार और प्रोटोटाइप का संचालन करें।" },
      { title: "निर्माण और विकास", icon: Rocket, description: "अधिकतम दक्षता के लिए चुस्त कार्यप्रणाली का उपयोग करके, हमारी विशेषज्ञ विकास टीम के साथ अपनी दृष्टि को जीवंत करें।" },
      { title: "लॉन्च और विपणन", icon: Flag, description: "एक रणनीतिक लॉन्च और लक्षित अधिग्रहण अभियानों के साथ अपने उत्पाद को दुनिया के सामने पेश करें।" },
      { title: "स्केल और विकास", icon: Award, description: "अपनी पहुंच का विस्तार करें, अपने रूपांतरण फ़नल को अनुकूलित करें, और अपने संचालन को विश्व स्तर पर बढ़ाएं।" },
    ]
  },
};
