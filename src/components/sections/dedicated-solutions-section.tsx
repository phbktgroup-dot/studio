...
const sectionText = {
  ...
  hi: {
    ...
    shopsTab: "स्थानीय दुकानों के लिए",
    startupsTab: "स्टार्टअप के लिए",
    shops: {
      title: "पड़ोस के व्यवसायों को सशक्त बनाना",
      description: "अपने कार्यों को डिजिटल बनाएं, अपनी पहुंच बढ़ाएं, और हमारे समुदायों के दिल के लिए डिज़ाइन किए गए हमारे कस्टम समाधानों के साथ अनुपालन को सरल बनाएं।",
      features: [
        "इन्वेंटरी और बिलिंग ऐप्स",
        "स्थानीय एसईओ और गूगल मैप्स उपस्थिति",
    ...
    startups: {
      ...
      description: "हम महत्वाकांक्षी संस्थापकों के साथ विघटनकारी उत्पादों का निर्माण, लॉन्च और स्केल करने के लिए साझेदारी करते हैं। आपकी दृष्टि, हमारी विशेषज्ञता द्वारा त्वरित।",
      features: [
        "रैपिड एमवीपी विकास",
        "स्केलेबल क्लाउड आर्किटेक्चर",
        "गो-टू-मार्केट ब्रांडिंग",
        "निवेशक पिच डेक और डी-रिस्किंग",
      ],
